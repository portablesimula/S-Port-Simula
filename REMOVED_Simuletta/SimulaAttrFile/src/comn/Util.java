...
public class Util {
	...
	public static boolean sysattrfile;
	public static int xcateg;
	public static int xkind;
	public static int xtype;
	public static int xprefq;
	public static int xftag;
	public static int xspecial;
	public static int xinrtag;
	public static boolean xhasCode;
	public static boolean xthisused;
	public static boolean fetchquant;
	public static String xcheck;
	
	public static int xprotect;
	public static int xdim;
	public static int xlongindic;
	public static int xconnests;

	public static int sourceline;
//	public static boolean sysattrfile;
//	public static int key;
	public static String xident;
//	public static String xidentstring;
	public static int xclf;
	public static int xextident;
	public static int xlanguage;
	public static int xtagnum;
	public static String xprefix;
	public static String xmodul;
	public static String xextidentstring;
	public static String xlanguagestring;
	public static quantity cause;
	
	public static String XQUANTtoString() {
		StringBuilder sb=new StringBuilder();
		if(xkind==K_class) sb.append("\n").append(edIndent());
//		if(parameter) sb.append("parameter ");
		else sb.append(K_code(xkind)).append(" ");
//		if(xidentstring!=null) sb.append(xidentstring);
		if(xident!=null) sb.append(xident);
		if(xkind==K_class && xprefix != null && xprefix.length() > 0 ) sb.append(':').append(xprefix);
		sb.append(" ");
		if(xftag!=0)	sb.append("xftag=").append(xftag).append(" ");
		if(xtype!=14) sb.append("xtype=").append(edType(xtype)).append(" ");
//		sb.append("kind=").append(K_code(kind)).append(" ");
		sb.append("xcateg=").append(C_code(xcateg)).append(" ");
		sb.append("xclf=").append(xclf).append(" ");
		if(xspecial!=0)	sb.append("xspecial=").append(xspecial).append(" ");
		if(xprotect!=0)	sb.append("xprotect=").append(xprotect).append(" ");
		if(xdim!=0)	sb.append("xdim=").append(xdim).append(" ");
		if(xlongindic!=0) sb.append(", xlongindic=").append(xlongindic);
		if(xconnests!=0) sb.append(", xconnests=").append(xconnests);
		if(xlanguagestring!=null && xlanguagestring.length()>0) sb.append(" xlanguage=").append(xlanguagestring).append(" ");
		if(xextidentstring!=null && xextidentstring.length()>0) sb.append(" extident=").append(xextidentstring).append(" ");
		return(sb.toString());
	}

//	static quantity q,qe,qx,qq;
//	static extmodule currentextmodule;
//	static String t;
	public static boolean markermade; //! False as long as no marker made;
	public static boolean generate;   //! True if quantlist must be expanded;
...
//         ----- Inline coded procedures:
     ...
     static Vector<String> IDTABLE=new Vector<String>();
     public static int DEFIDENT(String id) {
    	 // TODO Auto-generated method stub
    	 IDTABLE.add(id);
    	 int res=IDTABLE.size()-1;
//    	 String id2=IDTABLE.get(res);
//         System.out.println("Util.DEFIDENT: id="+id);
//         System.out.println("Util.DEFIDENT: id2="+id2);
    	 return(res);
     }
     
     public static String GETIDENT(int key) {
    	 try { return(IDTABLE.get(key)); }
    	 catch(Exception e) { }
    	 return("NOIDENT");
     }
