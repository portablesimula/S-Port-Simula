...
public class MakeFEC {
	...
	public static void main(String[] argv) {
		...
		compile("CLASS_CHECKER2.sim"); // Output -> C:\GitHub\S-Port-Simula\FEC\src\fec\source\bin\CLASS_CHECKER2.jar
		
		compile("CLASS_SCODER0.sim");  // Output -> C:\GitHub\S-Port-Simula\FEC\src\fec\source\bin\CLASS_SCODER0.jar
		compile("CLASS_SCODER1.sim");  // Output -> C:\GitHub\S-Port-Simula\FEC\src\fec\source\bin\CLASS_SCODER1.jar
		compile("CLASS_SCODER1E.sim"); // Output -> C:\GitHub\S-Port-Simula\FEC\src\fec\source\bin\CLASS_SCODER1E.jar	
		compile("CLASS_SCODER2.sim");  // Output -> C:\GitHub\S-Port-Simula\FEC\src\fec\source\bin\CLASS_SCODER2.jar
		compile("CLASS_SCODER3.sim");  // Output -> C:\GitHub\S-Port-Simula\FEC\src\fec\source\bin\CLASS_SCODER3.jar
		compile("CLASS_SCODER4.sim");  // Output -> C:\GitHub\S-Port-Simula\FEC\src\fec\source\bin\CLASS_SCODER4.jar
		
		compile("CLASS_PAS2INIT.sim"); // Output -> C:\GitHub\S-Port-Simula\FEC\src\fec\source\bin\CLASS_PAS2INIT.jar
		compile("CLASS_SCODMAIN.sim"); // Output -> C:\GitHub\S-Port-Simula\FEC\src\fec\source\bin\CLASS_SCODMAIN.jar
...
//		compile("MessageGenerator.sim");  // WILL GENERATE ERROR MESSAGE FILE FECERROR.txt
		...
		compile("FEC.sim");  // WILL CREATE THE S-PORT COMPILER:  C:\GitHub\S-Port-Simula\FEC\src\fec\source\bin\FEC.jar
		copyFECtoSPORT_HOME();
	}
