...
public final class FECmpRTS {
	...
	public static void main(String[] args) {
		...
		names.add("RT");   // ==> C:/GitHub/S-Port-Simula/FILES/simulaRTS/SCode/RT.scd
		names.add("SYSR"); // ==> C:/GitHub/S-Port-Simula/FILES/simulaRTS/SCode/SYSR.scd
		names.add("KNWN"); // ==> C:/GitHub/S-Port-Simula/FILES/simulaRTS/SCode/KNWN.scd
		names.add("UTIL"); // ==> C:/GitHub/S-Port-Simula/FILES/simulaRTS/SCode/UTIL.scd
		
		names.add("STRG"); // ==> C:/GitHub/S-Port-Simula/FILES/simulaRTS/SCode/STRG.scd
		names.add("CENT"); // ==> C:/GitHub/S-Port-Simula/FILES/simulaRTS/SCode/CENT.scd
		names.add("CINT"); // ==> C:/GitHub/S-Port-Simula/FILES/simulaRTS/SCode/CINT.scd
		names.add("ARR");  // ==> C:/GitHub/S-Port-Simula/FILES/simulaRTS/SCode/ARR.scd
		names.add("FORM"); // ==> C:/GitHub/S-Port-Simula/FILES/simulaRTS/SCode/FORM.scd
		names.add("LIBR"); // ==> C:/GitHub/S-Port-Simula/FILES/simulaRTS/SCode/LIBR.scd
		names.add("FIL");  // ==> C:/GitHub/S-Port-Simula/FILES/simulaRTS/SCode/FIL.scd
		names.add("SMST"); // ==> C:/GitHub/S-Port-Simula/FILES/simulaRTS/SCode/SMST.scd
		names.add("SML");  // ==> C:/GitHub/S-Port-Simula/FILES/simulaRTS/SCode/SML.scd
		names.add("EDIT"); // ==> C:/GitHub/S-Port-Simula/FILES/simulaRTS/SCode/EDIT.scd
		names.add("MNTR"); // ==> C:/GitHub/S-Port-Simula/FILES/simulaRTS/SCode/MNTR.scd
		...
		names.add("RTS$INTERFACE"); // Will call RTS_FEC_InterfaceGenerator  which creates the files:
									...
									// - "C:/GitHub/S-Port-Simula/SimulaFEC/src/fec/source/RTSINIT.ini"
									//    C:\GitHub/S-Port-Simula/FEC/src/fec/source/RTSINIT.ini
		
									// - "C:/GitHub/S-Port-Simula/SimulaFEC/src/fec/RTS-FEC-INTERFACE1.def"
		                            // - "C:/GitHub/S-Port-Simula/SimulaFEC/src/fec/RTS-FEC-INTERFACE2.def"
...
//		File userDir=new File("C:/WorkSpaces/SimulettaFECinJava/SimulettaFEC");
		File userDir=new File("C:/GitHub/S-Port-Simula/SimulettaFEC");
...
//		Global.outputDir=new File("C:/Simuletta");
		...
		Global.outputDir=new File("C:/GitHub/S-Port-Simula/FILES");
