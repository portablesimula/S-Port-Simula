...
//		FileReader inpt=new FileReader("C:/WorkSpaces/SimulettaFECinJava/SimulettaFEC/src/simulaRTS/sml/RTSINIT1.def");
		FileReader inpt=new FileReader("C:/GitHub/S-Port-Simula/SimulettaFEC/src/simulaRTS/sml/RTSINIT1.def");
		FileWriter oupt=new FileWriter("C:/GitHub/S-Port-Simula/SimulaFEC/src/fec/source/RTS-FEC-INTERFACE1.def");
...
//		inpt=new FileReader("C:/WorkSpaces/SimulettaFECinJava/SimulettaFEC/src/simulaRTS/sml/RTSINIT2.def");
		inpt=new FileReader("C:/GitHub/S-Port-Simula/SimulettaFEC/src/simulaRTS/sml/RTSINIT2.def");
		oupt=new FileWriter("C:/GitHub/S-Port-Simula/SimulaFEC/src/fec/source/RTS-FEC-INTERFACE2.def");
		oupt.write("integer RTS_TAG_LIMIT=1774;\n");
		doGenerateTagDefs(inpt,oupt);
		
		doGeneratePredefAttrFile();

		oupt=new FileWriter("C:/GitHub/S-Port-Simula/SimulaFEC/src/fec/source/RTS-FEC-TAGTABLE.def");
...
//					System.out.println("RTS_FEC_InterfaceGenerator.treatLine: xcode="+xcode);
	...
	private static void doGenerateRTSInit(String moduleident) throws IOException {
		...
		String fileName="C:/GitHub/S-Port-Simula/SimulaFEC/src/fec/source/RTSINIT.ini";
...
//		if (Option.verbose)
	...
	// C:/GitHub/S-Port-Simula/SimulaFEC/src/fec/source/PREDEF.ATR
...
//		String fileName = "C:/WorkSpaces/SimulettaFECinJava/SimulettaFEC/src/simuletta/RTS_FEC_InterfaceGenerator/predef/PREDEF.DEF";
		String fileName = "C:/GitHub/S-Port-Simula/SimulettaFEC/src/simuletta/RTS_FEC_InterfaceGenerator/predef/PREDEF.DEF";
		File outputFile=new File("C:/GitHub/S-Port-Simula/SimulaFEC/src/fec/source/PREDEF.ATR");
